...
const DatePickerInput = forwardRef<HTMLInputElement, DatePickerInputProps>((props, ref) => {
	...
	return <input type="text" className={`form-control ${props.inputClass}`} onClick={props.onClick} value={props.value} onChange={onDateValueChange} ref={ref} />
})
...
const DatePickerInputWithAddon = forwardRef<HTMLInputElement, DatePickerInputProps>((props, ref) => (
	<div className="input-group" ref={ref}>
		<input type="text" className={`form-control ${props.inputClass}`} onClick={props.onClick} value={props.value} readOnly />
...
const CustomDatepicker = (props: CustomDatepickerProps) => {
	...
	const input = (props.hideAddon || false) === true ? <DatePickerInput inputClass={props.inputClass} value={props.value.toDateString()} /> : <DatePickerInputWithAddon variant={props.variant} inputClass={props.inputClass} value={props.value.toDateString()} />

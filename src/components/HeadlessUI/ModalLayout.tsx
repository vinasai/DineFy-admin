...
//showModal, toggleModal, panelClassName, children, placement, isStatic 
const ModalLayout = ({ }: ModalLayoutProps) => {
	return (
		...
		// 						<Dialog.Panel className={`text-left align-middle transition-all min-h-full duration-300 overflow-y-auto transform overflow-hidden rounded-lg ${panelClassName}`}>{children}</Dialog.Panel>
		// 					</div>
		// 				</Transition.Child>
		// 			</div>
		// 		</div>
